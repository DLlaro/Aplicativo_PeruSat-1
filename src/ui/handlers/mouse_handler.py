...
class MouseHandler:
    ...
    def connect(self):
        self.mw.viewer_mgr.model.mouse_move_callbacks.append(self.on_mouse_move)
        self.mw.viewer_mgr.model.mouse_drag_callbacks.append(self.on_drag)

    def disconnect(self):
        self.mw.viewer_mgr.model.mouse_move_callbacks.remove(self.on_mouse_move)
        self.mw.viewer_mgr.model.mouse_drag_callbacks.remove(self.on_drag)
    ...
    def _actualizar_coordenadas(self, viewer, event):
        ...
        """
        # 1. Validación básica
        if not self.mw.viewer_mgr.model.layers:
        ...
        try:
            ...
            cursor_pos = self.mw.viewer_mgr.model.cursor.position
    ...
    def _drag_handler(self, viewer, event):
        ...
        while event.type == "mouse_move":
            ...
            if self.mw.viewer_mgr._layers["ROI"].mode == "add_rectangle":
        ...
        self.mw.roi_manager.set_roi_to_coords(self.mw.viewer_mgr._layers["ROI"].data)  # esto actualiza self.mw.roi_manager.coords_roi con las coordenadas reales del ROI
